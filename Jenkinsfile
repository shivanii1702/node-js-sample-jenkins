pipeline {
    agent any
    environment {
        AWS_ACCOUNT_ID="590183693243"
        AWS_DEFAULT_REGION="us-east-1"
	    CLUSTER_NAME="jenkins-cluster-ash"
	    SERVICE_NAME="jenkins-svc"
	    TASK_DEFINITION_NAME="jenkins-tdf"
	    DESIRED_COUNT="1"
	    ...
	    registryCredential = "Github_Credentails"
